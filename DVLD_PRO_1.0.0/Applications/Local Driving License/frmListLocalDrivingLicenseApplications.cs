...
namespace DVLD_PRO_1._0._0.Applications.Local_Driving_License
{
    public partial class frmListLocalDrivingLicenseApplications : Form
    {
        ...
        private void btnNewLDLApp_Click(object sender, EventArgs e)
        {
        ...
        private void frmListLocalDrivingLicenseApplications_Load(object sender, EventArgs e)
        {
            ...
            dgvLDLApp.DataSource = _dtAllLocalDrivingLicenseApplications;
        ...
        private void txtFilterBy_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtFilterBy.Text.Trim() == "" || FilterColumn == "None")
            {
                ...
                lblRecordsCount.Text = dgvLDLApp.Rows.Count.ToString();
                return;
            }
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            ...
            IssueDLToolStripMenuItem.Enabled = (TotalPassedTests == 3) && !LicenseExists;
            ...
            DeleteAppToolStripMenuItem.Enabled =
        ...
        private void IssueDLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            int LocalDrivingLicenseApplicationID = (int)dgvLDLApp.CurrentRow.Cells[0].Value;
